...
class MainActividad extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        Provider<VacaApi>(create: (_) => VacaApi.create(),),
...
class _VacaUIState extends State<VacaUI> {
        ...
        body: FutureBuilder<List<VacaModelo>>(
          ...
          builder: (BuildContext context,
            ...
            if (snapshot.hasError) {
              ...
              List<VacaModelo> persona = snapshot.data!!;
  ...
  Widget _buildListView(BuildContext context, List<VacaModelo> persona) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 8.0),
      child: ListView.builder(
        itemBuilder: (context, index) {
          VacaModelo personax = persona[index];
          return Padding(
