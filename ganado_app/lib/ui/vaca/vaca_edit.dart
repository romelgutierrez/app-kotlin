...
class VacaFormEdit extends StatefulWidget {
  VacaModelo modelA;

  VacaFormEdit({required this.modelA}):super();

  @override
  _VacaFormEditState createState() => _VacaFormEditState(modelA: modelA);
}

class _VacaFormEditState extends State<VacaFormEdit> {
  VacaModelo modelA;
  _VacaFormEditState({required this.modelA}):super();
  ...
  void capturaNombreAct(valor){ this._nombreVaca=valor;}
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildDatoCadena(capturaNombreAct, modelA.nombreVaca, "Nombre Actividad:"),
