...
class VacaForm extends StatefulWidget {
  @override
  _VacaFormState createState() => _VacaFormState();
}

class _VacaFormState extends State<VacaForm> {
...
//mp.estado=_estado;
                              ...
                              //  mp.validInsc=_validarInsc;
                               ...
                               // mp.offlinex=_offlienex;
                                /*
                                print("NA:${_nombreVaca}, E:${_estado}, "
                                ...
                                */
                                var api = await Provider.of<VacaApi>(
                                    context,
                                    listen: false)
